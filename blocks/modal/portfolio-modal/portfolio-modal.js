...
function initPortfolioModal() {
    ...
    function closeModal() {
        modal.classList.remove('portfolio-modal_active');
    ...
    function openModal(work) {
        ...
        const yearEl = document.querySelector('.portfolio-modal-work__meta-value_year');
        const techniqueEl = document.querySelector('.portfolio-modal-work__meta-value_technique');
        ...
        modal.classList.add('portfolio-modal_active');
    ...
    document.addEventListener('keydown', (e) => {
        if (e.key === 'Escape' && modal.classList.contains('portfolio-modal_active')) {
            closeModal();
        }
    });
